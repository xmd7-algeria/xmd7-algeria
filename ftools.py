...
print('''
                           \033[0;32m ╔--─────────────────────────────────-----------------------------╗
                           \033[0;32m |      [#] : Coded by alaa-dz                                    |
                           \033[0;32m |      Thanks my brother : https://www.facebook.com/mahdiSTH.7   |
                           \033[0;32m |      FB :https://www.facebook.com/elliot.alderson.77715869     |
                           \033[0;32m ╚--────────────────────------------------------------------------╝
''')     
...
configFile = installDir + "/ftools.cfg"
print(installDir)
config = ConfigParser.RawConfigParser()
config.read(configFile)

toolDir = installDir + config.get('ftools', 'toolDir')
logDir = installDir + config.get('ftools', 'logDir')
yes = config.get('ftools', 'yes').split()
color_random=[color.HEADER,color.IMPORTANT,color.NOTICE,color.OKBLUE,color.OKGREEN,color.WARNING,color.RED,color.END,color.UNDERLINE,color.LOGGING]
random.shuffle(color_random)
ftoolslogo = color_random[0] + print('''
                           \033[0;32m             ▄▄▄▄▄▄▄▄▄▄▄  ▄▄▄▄▄▄▄▄▄▄▄  ▄▄▄▄▄▄▄▄▄▄▄  ▄▄▄▄▄▄▄▄▄▄▄  ▄            ▄▄▄▄▄▄▄▄▄▄▄ 
                           \033[0;32m            ▐░░░░░░░░░░░▌▐░░░░░░░░░░░▌▐░░░░░░░░░░░▌▐░░░░░░░░░░░▌▐░▌          ▐░░░░░░░░░░░▌
                            \033[0;32m            ▐░█▀▀▀▀▀▀▀▀▀  ▀▀▀▀█░█▀▀▀▀ ▐░█▀▀▀▀▀▀▀█░▌▐░█▀▀▀▀▀▀▀█░▌▐░▌          ▐░█▀▀▀▀▀▀▀▀▀ 
                            \033[0;32m            ▐░▌               ▐░▌     ▐░▌       ▐░▌▐░▌       ▐░▌▐░▌          ▐░▌          
...
mrbx1 = color.NOTICE + '''
Hello,
As we all know, Mr. BX1 1.0 is comming out - the end of Mr. BX1.
We will update to python3.7 & add all of the new hacking tool of 1.0 

This is to keep cannon to the show.))
Feel free to join the facebook group 
Anything Mr.BX1 will be on the server!
Thanks for reading,
--------BX1---------
-------Mahdi Frikha--------'''
...
class :
    ...
    Yb      Yb   dP 88 Y88   88   88"Yb  88 88""Yb o.`Y8b
     ...
     ''')
        contributorsURL = 'https://api.github.com/repos/manisso//contributors'
    ...
    def update(self):
        os.system("git clone --depth=1 https://github.com/Manisso/.git")
        os.system("cd  && bash ./update.sh")
        os.system("")
...
class sniffingSpoofingMenu:
    ...
    def __init__(self):
        ...
        choice6 = raw_input(fstoolsPrompt)
        clearScr()
        if choice6 == "1":
            setoolkit()
        elif choice6 == "2":
